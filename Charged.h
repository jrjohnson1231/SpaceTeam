...
{
	public:
		Charged(string name, string imagename, SDL_Surface* screen, double m=9.1e-31, double q=1.6e-19, double x=0, double y=0, double z=0, double vx=0, double vy=0, double vz=0);
